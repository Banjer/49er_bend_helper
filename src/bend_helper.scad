...
difference ()
	...
	translate ([0, -30, -1]) {cylinder (r = r_mast+t_skin, h = l_meter+2);}
	translate ([0, r_line+r_mast+15, -10]) {cylinder (r = r_line,h = 60);}
	translate ([0, r_line+r_mast+45, -10]) {cylinder (r = 30, h = 70);}
	translate ([r_mast+t_skin+15, 0, 5]) {cylinder (r = 15, h = 100);}
	translate ([-(r_mast+t_skin+15), 0, 5]) {cylinder (r = 15, h = 100);}
	translate ([(r_mast+t_skin+4), 0, -1]) {cylinder (r = 2, h = 100);}
	translate ([-(r_mast+t_skin+4), 0, -1]) {cylinder (r = 2, h = 100);}
	translate ([0, 37, 1]) {
